...
$this->title = 'Acne Follow';
?>
<div class="site-index">
	<h1>Bienvenido</h1><br>
	
	<div class="bs-callout bs-callout-info textIndex" id="callout-glyphicons-location">
		<p> <span style="font-weight: bold">Hola, </span>Si ha llegado a esta p&aacute;gina muy seguramente usted, un familiar o amigo cercano padece de acn&eacute;.</p>
